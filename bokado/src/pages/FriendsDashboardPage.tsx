      ...
      <header className="dashboard-header">
        ...
        <div className="dashboard-tabs">
          ...
          >
            ...
            <span>Friends {myFriends.length > 0 && <span className="badge">{myFriends.length}</span>}</span>
          </button>
          <button 
          ...
          >
            ...
            <span>Likes {whoLikedMe.length > 0 && <span className="badge">{whoLikedMe.length}</span>}</span>
          </button>
        </div>
      </header>
            ...
            <div className="likes-grid">
              <section className="liked-section">
                <h2 className="section-title">
                  ...
                  <span>Who Liked You ({whoLikedMe.length})</span>
                </h2>
                <div className="users-grid">
              ...
              <section className="liked-section">
                <h2 className="section-title">
                  <FiHeart className="section-icon" />
                  <span>Your Likes ({iLikedUsers.length})</span>
                </h2>
                <div className="users-grid">
